    ...
    <div className='login-popup'>
      <form onSubmit={onLogin} className="login-popup-container">
        ...
        <div className="login-popup-condition">
            ...
            <p>Aceite os termos de uso</p>
        </div>
        {currState==="Login"
        ?<p>Criar nova Conta? <span onClick={()=>setCurrState("Sign Up")}>Clique Aqui!</span></p>
        :<p>Ja possui uma conta? <span onClick={()=>setCurrState("Login")}>Entrar</span></p>
        }
